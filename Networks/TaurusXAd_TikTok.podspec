Pod::Spec.new do |spec|
  ...
  spec.vendored_frameworks  = "TaurusXAd_TikTok_#{spec.version}/BUAdSDK.framework", "TaurusXAd_TikTok_#{spec.version}/BUCNAuxiliary.framework", "TaurusXAd_TikTok_#{spec.version}/BUFoundation.framework"
