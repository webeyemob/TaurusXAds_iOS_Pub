Pod::Spec.new do |spec|
  ...
  spec.dependency 'MintegralAdSDK/BannerAd', '6.9.6.0'
  spec.dependency 'MintegralAdSDK/InterActiveAd', '6.9.6.0'
  spec.dependency 'MintegralAdSDK/InterstitialAd', '6.9.6.0'
  spec.dependency 'MintegralAdSDK/InterstitialVideoAd', '6.9.6.0'
  spec.dependency 'MintegralAdSDK/NativeAdvancedAd', '6.9.6.0'
  spec.dependency 'MintegralAdSDK/RewardVideoAd', '6.9.6.0'
  spec.dependency 'MintegralAdSDK/SplashAd', '6.9.6.0'
