...
/*!
@method updateMediaGroupImageList
...
/*!
@method getAllViewArray
@abstract get all views in native layout
@result NSMutableArray<UIView *>
*/
-(NSMutableArray<UIView *> *)getAllViewArray;

/*!
@method getNonMediaViewArray
@abstract get all views that is not media in native layout
@result NSMutableArray<UIView *>
*/
