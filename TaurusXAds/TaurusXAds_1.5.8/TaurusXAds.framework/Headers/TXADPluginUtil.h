...
/// TXADBannerAdPosition.
+ (void)positionView:(UIView *)view inParentView:(UIView *)parentView adPosition:(TXADBannerAdPosition)position;
...
+ (void)positionView:(UIView *)view inParentView:(UIView *)parentView adPosition:(TXADBannerAdPosition)position x:(int)x y:(int)y;
