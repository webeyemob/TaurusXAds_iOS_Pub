...
/// AdContentInfo
// 对 Unity 中 AdContentInfo 的引用。
typedef const void *TXADTypeAdContentRef;
...
typedef void (*TXADTrackAdCallShowCallback)(TXADTypeTrackerClientRef *trackerClientRef,
											float eCPM, int networkId, char *networkAdUnitId, char *adUnitId, char *adUnitName, int adType, TXADTypeAdContentRef *adContentInfoRef);
...
typedef void (*TXADTrackAdUnitCallShowCallback)(TXADTypeTrackerClientRef *trackerClientRef, char *adUnitId, char *adUnitName, int adType, TXADTypeAdContentRef *adContentInfoRef);
...
typedef void (*TXADTrackAdUnitClickedCallback)(TXADTypeTrackerClientRef *trackerClientRef, char *adUnitId, char *adUnitName, int adType, TXADTypeAdContentRef *adContentInfoRef);
