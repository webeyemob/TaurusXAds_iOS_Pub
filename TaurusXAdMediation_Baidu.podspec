Pod::Spec.new do |spec|
  ...
  spec.vendored_frameworks  = "TaurusXAdMediation_Baidu_#{spec.version}/TaurusXAdMediation_Baidu.xcframework"
  spec.dependency "TaurusXAds"
  spec.dependency 'BaiduMobAdSDK', '= 4.841'
end