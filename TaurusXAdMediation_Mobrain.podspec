Pod::Spec.new do |spec|
  ...
  spec.vendored_frameworks  = "TaurusXAdMediation_Mobrain_#{spec.version}/TaurusXAdMediation_Mobrain.xcframework", "TaurusXAdMediation_Mobrain_#{spec.version}/ABUAdSDK.framework"
