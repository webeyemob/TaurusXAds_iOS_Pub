Pod::Spec.new do |spec|
  ...
  spec.dependency 'MintegralAdSDK', '~> 5.8.4.0'
  spec.dependency 'MintegralAdSDK/BannerAd', '~> 5.8.4.0'
  spec.dependency 'MintegralAdSDK/InterActiveAd', '~> 5.8.4.0'
  spec.dependency 'MintegralAdSDK/InterstitialAd', '~> 5.8.4.0'
  spec.dependency 'MintegralAdSDK/InterstitialVideoAd', '~> 5.8.4.0'
  spec.dependency 'MintegralAdSDK/RewardVideoAd', '~> 5.8.4.0'
